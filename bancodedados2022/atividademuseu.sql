 ...
 \copy ( select * from cadastro where idade >= 18 ) to 'C:\Users\alice_k_alves\Downloads\menores_de_18.csv' delimiter ';' csv header;
 // para visualizar os cadastros em que a pessoa possui 18 ou mais anos.

 \copy ( select * from funcionarios where salario < 1000 ) to 'C:\Users\alice_k_alves\Downloads\funcionarios_menores_milreais' delimiter ';' csv header; // para visualizar os funcionários que ganham menos de mil reais
 ...
 \copy ( select * from obras where tipo ilike '%pintura%' ) to 'C:\Users\alice_k_alves\Downloads\obras_tipo_pintura' delimiter ';' csv header;
 // para visualizar todas as obras que sejam do tipo “pintura”.
